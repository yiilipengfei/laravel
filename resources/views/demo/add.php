    ...
    <div class="search-box">
        <form action="">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed-name" type="text">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" type="text">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" value="" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text" value="" placeholder="请输入最大长度">
                </li>
                <li>
